...
builds:
  ...
  - damage: '4.9'
    ...
    - color: teal
      ...
      type: support
    - color: pink
      description: Arctic Wind inflicts Root for 1.75.
  ...
  - damage: '6.1'
    ...
    - color: pink
      description: Whenever you inflict Freeze, your Frost Bolts are empowered for
        3.5. They deal 4 bonus damage and inflict Chill even on targets without Chill.
  ...
  - damage: '6.1'
    ...
    - color: pink
      description: Frozen Gallery inflicts Chill for 4 to enemies in the area when
        the path appears. Also increases Freeze duration from 3 to 4.
