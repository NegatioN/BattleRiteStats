...
builds:
  ...
  - damage: '6.4'
    ...
    - color: blue
      ...
      type: utility
    - color: grey
      description: Hitting a wall with Stalking Phantom's initial dash triggers a
        wall jump that inflicts Incapacitate. Recast to remove negative effects and
        switch places with Stalking Phantom after its arrival.
