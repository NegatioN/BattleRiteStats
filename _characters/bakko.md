...
builds:
  ...
  - damage: '6.3'
    ...
    - color: pink
      ...
      type: control
    - color: grey
      description: The first attack blocked by Bulwark grants a Shield to the nearby
        ally with the least health. The Shield absorbs up to 18 damage and lasts for
        3.
      icon: 1d33cdf1e3619d74b8b0e7eb9f19a531
      name: Hold the Line
      type: mixed
  ...
  - damage: '3.9'
    ...
    - color: pink
      ...
      type: control
    - color: pink
      description: Increases Stun duration of Heroic Charge by 0.75.
  ...
  - damage: '6.3'
    ...
    - color: teal
      ...
      type: support
    - color: pink
      description: Shield Dash inflicts 20 Snare for 2.5. Pushing an enemy into a
        wall deals 6 bonus damage.
      icon: 84ba51168b08df3489362e3a9be59704
      name: Dizzying Dash
      type: control
    - color: grey
