...
builds:
  ...
  - damage: '3.2'
    ...
    - color: pink
      ...
      type: control
    - color: teal
      description: Each enemy hit with Lunar Strike restores 1 Sunlight charge. Hitting
        at least one enemy empowers your next Sunlight, causing 1 additional beam
        to heal the ally nearest the area for 12 health.
      icon: f138c9c126ce8934bbe8d6ba98327181
      name: Moonlight
      type: support
    - color: green
