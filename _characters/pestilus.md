...
builds:
  ...
  - damage: '5.0'
    ...
    - color: yellow
      ...
      type: mobility
    - color: red
      description: Queen slows nearby enemies movement speed by 20 and deals 8 bonus
  ...
  - damage: '5.0'
    ...
    skills:
    - color: green
      description: Hitting a champion affected by Moth or a Queen with Bloodsucker
        causes Moth to spread to nearby enemies.
      icon: 991db4d450443e9498711ab935bedf13
      name: Colony
      type: survival
    - color: pink
